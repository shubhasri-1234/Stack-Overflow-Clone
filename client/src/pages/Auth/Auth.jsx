   ...
   <section class='auth-section'>
     { isSignup && <AboutAuth/>}
        <div class='auth-container-2'>
            { !isSignup &&<img width="50" height="50" src={icon} alt='stack overflow' className='login-logo'/>}
                ...
                </label>
                {
                    isSignup &&(
                        <label htmlFor='check'>
                            ...
                            <p style={{fontSize:"13px"}}> Opt-in to receive occational<br/> product updates,user research invitations,<br/>company announcements,and digests.
                            </p>
